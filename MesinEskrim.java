...
class BatasEskrimException extends Exception {
 ...
 //mesin eskrim (disini hanya melayani eskrim) (utk pembayaran pastinya dikasir)
 //Pemesan memilih rasa. Jika rasa tidak ada, program lempar exception (max 3 eskrim)
...
public class MesinEskrim {
    ...
    public static void selectEskrim(String Eskrim, int jumlah) throws EskrimNotAvailableException, BatasEskrimException {
        ...
        if (jumlah > 3) {
            throw new BatasEskrimException("Maksimal 3 es krim.");
        }
        ...
        if (!Eskrim.equalsIgnoreCase("matcha") &&
            ...
            throw new EskrimNotAvailableException("Rasa '" + Eskrim + "' tidak tersedia");
        }
